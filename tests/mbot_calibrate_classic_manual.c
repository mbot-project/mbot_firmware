...
// This script does not determine the motor polarity
// User needs to define them (MOT_LEFT_POL/MOT_RIGHT_POL) here by trial and error
...
int main() {
    ...
    params.motor_polarity[MOT_L] = MOT_LEFT_POL;
    params.motor_polarity[MOT_R] = MOT_RIGHT_POL;
